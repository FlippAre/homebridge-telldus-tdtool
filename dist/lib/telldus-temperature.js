...
class TelldusTemperature extends TelldusAccessory {
  ...
  constructor(data, log, homebridge, config) {
    ...
    this.service.getCharacteristic(this.Characteristic.getCurrentTemperature).on('get', this.getCurrentTemperature.bind(this));

    this.meta.setCharacteristic(this.Characteristic.Model, "TemperatureSensor");
